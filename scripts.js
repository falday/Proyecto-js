...
function cargarUsuario () {
  if(localStorage.getItem('usuarioLogueado') !== null)
  {
   ...
   `<a class=" text-dark me-1" onclick="salirSesion()"> ${mostrarusuario.nombre}  Cerrar sesion</a>`;
    ...
    document.getElementById("cerrarSecion").innerHTML = 
    '<a class=" text-dark me-1"  href="/pages/Registro.html">Login/registro</a>'
  ...
  carrito.forEach((Npieza) => {
    ...
    document.getElementById("cards-modal").innerHTML += `
        ...
        <div class="d-flex flex-column card-body">
            ...
            - Stock: ${Npieza.stock}
            <div> - CANTIDAD: ${Npieza.cantidad}</div>
...
function comprar() {
  ...
  Swal.fire({
  title: 'Inicie Sesion',
  text: 'Para continuar con la compra',
  icon: 'error',
  showConfirmButton: false,
})
